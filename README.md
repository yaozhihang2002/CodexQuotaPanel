...
> 当前版本：**v0.1.0 Pre-release**。这是首个公开测试版，欢迎通过 GitHub 反馈实际使用中的兼容性和界面问题。
...
推荐从 GitHub Releases 下载 `CodexQuotaPanel-0.1.0-Setup.exe`。Release 同时提供中文原生 MSI、便携版 ZIP、源码 ZIP 与 SHA-256 校验文件。
